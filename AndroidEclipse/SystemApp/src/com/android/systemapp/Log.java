...
public class Log {
    ...
    public static final String TAG = "SystemApp";

    public static final boolean FORCE_DEBUG = SystemProperties.getBoolean("persist.sys.log.systemapp", false); /* STOPSHIP if true */
